...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ManagedResourceBindingItem) DeepCopyInto(out *ManagedResourceBindingItem) {
	*out = *in
	out.Object = in.Object
	if in.Verbs != nil {
		in, out := &in.Verbs, &out.Verbs
		*out = make([]utils.Verb, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ManagedResourceBindingItem.
func (in *ManagedResourceBindingItem) DeepCopy() *ManagedResourceBindingItem {
	if in == nil {
		return nil
	}
	out := new(ManagedResourceBindingItem)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ManagedResourceBindingSpec) DeepCopyInto(out *ManagedResourceBindingSpec) {
	*out = *in
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]ManagedResourceBindingItem, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
